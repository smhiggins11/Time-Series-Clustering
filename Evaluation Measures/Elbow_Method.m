function TWSS = Elbow_Method(k,Cluster_Centroids,Cluster_Vectors,Distance_Metric)
%% Elbow Method
...
TWSS = sum(Within_Cluster_Sum); % Sum of all clusters' sums of squared distances
end